...
class VendorAddProductComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.vendor.product.vendor-add-product-component',['categories'=>$categories,'sub_categories'=>$sub_categories,'types'=>$types,'sub_types'=>$sub_types,'pattributes'=>$parrributes,'brands'=>$brands])->layout('layouts.vendor');
    }
}
