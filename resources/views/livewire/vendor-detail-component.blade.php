                                    ...
                                    <ul>
                                        <li class="active">
                                            <a id="profile-tab" data-toggle="tab" href="#profile" role="tab"
                                                aria-controls="profile" aria-selected="true" wire:ignore>About
                                                Vendor</a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a id="featured-products-tab" data-toggle="tab" href="#featured-products"
                                                role="tab" aria-controls="featured-products" aria-selected="false"
                                                wire:ignore>Featured
                                                Products
                                            </a>
                                        </li>
                                        <li>
