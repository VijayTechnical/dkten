        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-description">You can edit Shipping Area from here</p>
                    <form class="forms-sample" wire:submit.prevent="editShippingArea()" enctype="multipart/form-data">
