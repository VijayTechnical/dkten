<div>
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Edit Shipping Region</h4>
                    <p class="card-description">You can edit Shipping Region from here</p>
                    <form class="forms-sample" wire:submit.prevent="editShippingRegion()" enctype="multipart/form-data">
