<div>
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Edit Eservice</h4>
                    <p class="card-description">You can Edit Eservice from here</p>
                    <form class="forms-sample" wire:submit.prevent="editEservice()" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            @else
                                <img src="{{ asset('/storage/eservice') }}/{{ $image }}" width="60" height="60"
                                    alt="">
                            @endif
                            @error('newimage')
                                <span class="error" role="alert">
