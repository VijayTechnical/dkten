        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-description">Edit slider from here.</p>
                    <form class="forms-sample" enctype="multipart/form-data" wire:submit.prevent="editSlider()">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    @else
                                    <img src="{{ asset('/storage/slider') }}/{{ $image }}" width="60" height="60" alt="">
                                    @endif
                                    @error('image')
