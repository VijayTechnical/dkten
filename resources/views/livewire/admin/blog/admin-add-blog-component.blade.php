        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-description">You can add Blog from here</p>
                    <form class="forms-sample" wire:submit.prevent="addBlog()" enctype="multipart/form-data">
                        ...
                        <div class="form-group" wire:ignore>
                            ...
                            <textarea type="text" class="form-control" rows="10" id="summary"
                                placeholder="Summary" wire:model="summary"></textarea>
                            @error('summary')
                                <span class="error" role="alert">
                                    <strong class="text-danger">{{ $message }}</strong>
                                </span>
