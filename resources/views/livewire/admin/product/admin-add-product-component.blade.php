        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-description">Add new product from here.</p>
                    <form class="forms-sample" enctype="multipart/form-data" wire:submit.prevent="addProduct()">
                        <ul class="nav nav-justified" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="btn btn-primary active" id="detail-tab" data-toggle="tab" href="#detail" role="tab"
                                    aria-controls="detail" aria-selected="true" wire:ignore>Product Details</a>
                            </li>
                            <li class="nav-item">
                                <a class="btn btn-primary " id="business-tab" data-toggle="tab" href="#business" role="tab"
                                    aria-controls="business" aria-selected="false" wire:ignore>Business Details</a>
                            </li>
                            <li class="nav-item">
                                <a class="btn btn-primary " id="customer_choice-tab" data-toggle="tab" href="#customer_choice" role="tab" aria-controls="customer_choice"
