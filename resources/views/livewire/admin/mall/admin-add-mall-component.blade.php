<div>
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Add Shopping Mall</h4>
                    <p class="card-description">You can add Shopping Mall from here</p>
                    <form class="forms-sample" wire:submit.prevent="addMall()" enctype="multipart/form-data">
