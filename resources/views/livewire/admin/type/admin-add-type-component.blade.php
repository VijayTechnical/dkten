        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-description">You can add Type from here</p>
                    <form class="forms-sample" wire:submit.prevent="addType()" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                <div class="form-group" wire:ignore>
                                    ...
                                    <select class="js-example-basic-multiple" data-placeholder="Select brands"
                                        id="brands" multiple="multiple" style="width:100%" wire:model.defer="sel_brands">
...
@push('scripts')
<script src="{{ asset('dk10_master_assets/vendors/select2/select2.min.js') }}"></script>
<script>
