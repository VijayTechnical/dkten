                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" wire:submit.prevent="editType()" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            @else
                            <img src="{{ asset('/storage/type') }}/{{ $image }}" width="60" height="60" alt="">
                            @endif
                            @error('newimage')
                            <span class="error" role="alert">
                                <strong class="text-danger">{{ $message }}</strong>
                            ...
                            <div class="col-md-6">
                                <div class="form-group" wire:ignore>
                                    ...
                                    <select class="js-example-basic-multiple" data-placeholder="Select brands"
                                        ...
                                        <option value="{{ $brand->id }}" @if (is_array($sel_brands) && in_array($brand->
                                            id, $sel_brands)) selected @endif>
                                            {{ $brand->name }}
                                        </option>
                                        @endforeach
                                    </select>
