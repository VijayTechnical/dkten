<div>
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Edit Vendor Type</h4>
                    <p class="card-description">You can Edit Vendor Type from here</p>
                    <form class="forms-sample" wire:submit.prevent="editVtype()" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" placeholder="Enter  Vendor Type Name..."
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="slug" placeholder="Enter  Vendor Type Slug..."
                                wire:model="slug">
                            @error('slug')
                            <span class="error" role="alert">
                                <strong class="text-danger">{{ $message }}</strong>
                        ...
                        <div class="form-group">
                            ...
                            @else
                            <img src="{{ asset('/storage/vtype') }}/{{ $image }}" width="60" height="60" alt="">
                            @endif
                            @error('newimage')
                            <span class="error" role="alert">
                                <strong class="text-danger">{{ $message }}</strong>
