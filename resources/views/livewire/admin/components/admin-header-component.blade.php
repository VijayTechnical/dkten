            ...
            <ul class="navbar-nav navbar-nav-right">
                <li class="nav-item dropdown d-none d-lg-block">
                    <a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown"
                        href="{{ route('admin.product.add') }}">+ Create New Product</a>
                </li>
                ...
                <li class="nav-item dropdown border-left">
                    ...
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                        ...
                        @if ($key < 3) <a class="dropdown-item preview-item" href="{{ route('admin.contact') }}">
                ...
                {{-- <li class="nav-item dropdown border-left">
                    <a class="nav-link count-indicator dropdown-toggle" id="notificationDropdown" href="#"
                        ...
                        <span class="count bg-danger" style="height: 15px;width:15px;">
                            <p style="font-size: 10px;font-weight:700;">{{ $notifications->count() }}</p>
                        </span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                        ...
                        <a href="{{ route('admin.notification') }}"
                            ...
                            <div class="content">
                                <strong class="d-block">{{ Illuminate\Support\Str::limit($notification->data['email'],
                                    15) }}</strong>
                        ...
                        <a href="{{ route('admin.notification') }}"
                            ...
                            <div class="content">
                                ...
                                <span class="d-block">{{ $notification->data['name'] }} has ordered item through {{
                                    $notification->data['method'] }}</span>
                                <small class="date d-block">{{ $notification->data['created_at'] }}</small>
                            </div>
                        </a>
                        @endif
                    ...
                    <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                        <div class="navbar-profile">
                            <img class="img-xs rounded-circle"
                                src="{{ '/storage/admin' }}/{{ Auth::guard('admin')->user()->image }}"
                                alt="{{ Auth::guard('admin')->user()->name }}">
                            <p class="mb-0 d-none d-sm-block navbar-profile-name">{{ Auth::guard('admin')->user()->name
                                }}
                            </p>
